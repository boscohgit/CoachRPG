...
Target:
4 sets of 8-10 reps with RIR 2-3 after MRI review

Upgrade:
Next upgrade rule to be defined after 40 kg reaches controlled 4 sets of 10 reps

Note:
This refers to the seated machine chest press only. It is not the same lift as barbell bench press.
...
Recovery quality is more important than adding extra volume.

Leg development is currently behind upper body development and should receive increased attention.
